...
def handle_results(results):
    global host, hosts, port, ports, verbose, report, timeout, state, protocols, command, scan_info, dict_tcp_keys, csv, tcp, state, product, reason, name, version, extra, conf
    if not results == None:
...
def handle_results_thread(results):
    t = Thread(target=handle_results, args=(results))
